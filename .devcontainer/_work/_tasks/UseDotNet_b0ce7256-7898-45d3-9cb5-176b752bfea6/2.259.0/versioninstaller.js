...
class VersionInstaller {
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        var downloadPath = yield this.downloadFromFallbackUrl(feedFallbackUrl, this.packageType, version, downloadUrl);
                    }
                    catch (ex) {
                        tl.warning(tl.loc("CouldNotDownload", feedFallbackUrl, ex));
                        var downloadPath = yield this.downloadFromFallbackUrl("https://dotnetcli.azureedge.net/dotnet", this.packageType, version, downloadUrl);
                    }
                }
                // Extract
    ...
    downloadFromFallbackUrl(fallBackUrl, packageType, version, downloadUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var downloadPath = yield toolLib.downloadToolWithRetries(url);
            return downloadPath;
        });
    }
}
