...
agentpid=5359
agentprocessname=Agent.Listener
rootfolder="/workspaces/mslearn-tailspin-spacegame-web-fork/.devcontainer"
existagentversion=4.258.1
downloadagentversion=4.260.0
logfile="/workspaces/mslearn-tailspin-spacegame-web-fork/.devcontainer/_diag/SelfUpdate-20250906-220319.log"
restartinteractiveagent=1
